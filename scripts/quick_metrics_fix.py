...
print(f"   Corrected mAP@0.75:    {best_model['corrected_mAP@0.75']:.4f} (estimated)")
print(f"   Corrected mAP@0.5:0.95: {best_model['corrected_mAP@0.5:0.95']:.4f} (estimated)")

print("\n💡 Key Insights:")
print("   1. mAP@0.5 is EXACT (computed from per-class APs)")
print("   2. mAP@0.75 and mAP@0.5:0.95 are ESTIMATED (using correction factor)")
print("   3. All models show ~20% improvement by excluding background class!")
print("\n📌 For 100% accurate mAP@0.75:")
print("   Option A: Continue training - metrics will be corrected automatically")
print("   Option B: Run recompute_metrics.py on saved models (loads checkpoints)")
print("\n" + "="*80 + "\n")
